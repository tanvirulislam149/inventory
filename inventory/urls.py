...
from Stock.views import StockViewset, DashboardViewset, RecentActivitiesViewset
...
router.register('supplier', SupplierViewsets, basename="supplier")
...
router.register("recent", RecentActivitiesViewset, basename="recent")
